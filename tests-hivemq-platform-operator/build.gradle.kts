...
val testPlanOtherExcludeTags = "Containers,ContainerSecurityContext,ClusterDomainName,CustomConfig,Extensions,Licenses,Platform,PodSecurityContext,ServiceAccount,Services,Upgrade,Volumes"
