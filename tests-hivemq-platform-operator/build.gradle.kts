...
val testPlanOtherExcludeTags = "Containers,ClusterDomainName,CustomConfig,Extensions,Licenses,Platform,PodSecurityContext,ServiceAccount,Services,Upgrade,Volumes"
