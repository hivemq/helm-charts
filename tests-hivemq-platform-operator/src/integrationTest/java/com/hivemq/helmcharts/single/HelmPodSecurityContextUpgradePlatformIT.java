...
class HelmPodSecurityContextUpgradePlatformIT extends AbstractHelmChartIT {
    ...
    void updateConfigMap_withRootAndNonRootUsers_rollingRestart(final @NotNull ChartValues chartValues) throws Exception {
